...
ggplot(data = BaseModel, aes(x = Date, y = TP, group = Station_ID, colour = Station_ID)) +
    geom_line() +
...
ggplot(data = BaseModel, aes(x = Date, y = TPLoad.csum, group = Station_ID, colour = Station_ID)) +
    geom_line() +
    facet_wrap(~ Station_ID)
