...
LSPC188_tp<-ggplot(BaseModel,aes(x=Date,y=TP))+geom_line(data=subset(BaseModel,Station_ID=="HARPETH_1")) +theme_bw()+
  ...
  geom_point(data=subset(Grab.w, Station_ID==c("Frank_Down","Frank_CottonLn","Franklin_Site_2","Franklin_Site_3")), aes(x=Date, y=TP, fill=Station_ID))
...
grid.arrange(cc.temp,cc.sal,cc.do,cc.pH, ncol=1)
dev.off()
